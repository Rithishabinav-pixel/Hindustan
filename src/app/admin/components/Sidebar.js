        ...
        <ul className={styles.navList}>
          ...
          <li>
            <Link
              ...
              className={`${styles.navLink} ${
                pathname === '/admin/dashboard/case-studies' || pathname.match(/^\/admin\/dashboard\/case-studies\/(add|[0-9])/)
                  ? styles.active
                  : ''
              }`}
            >
          ...
          <li>
            <Link
              href="/admin/dashboard/case-studies/categories"
              className={`${styles.navLink} ${
                pathname === '/admin/dashboard/case-studies/categories' ? styles.active : ''
              }`}
            >
              <svg
                width="18"
